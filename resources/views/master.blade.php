...
<head>
    ...
    <title>SISTEM PENGAMBILAN KEPUTUSAN PENILAIAAN KARYAWAN</title>
    <!-- Favicon-->
        ...
        <aside id="leftsidebar" class="sidebar">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li> 
                                <form action="/logout" class="flex" method="POST">
                                    @csrf
                                    <div class="form">
                                        <button type="submit" class=" button btn btn-default waves-effect">
                                            <div class="icons">
                                                <i class="material-icons pr">input</i>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="/karyawan/perhitungan">
                            <i class="material-icons">assignment</i>
                            <span>Data Nilai</span>
                        </a>
                    </li>
                    <li>
                        <a href="/karyawan/hasil">
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2016 - 2017 <a href="javascript:void(0);">SPK penilaian kinerja karyawan</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.5
                </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                @yield('notification')
                <div class="font-26 font-bold">@yield('title')</div>
            </div>
            @yield('content')
        </div>
    </section>
